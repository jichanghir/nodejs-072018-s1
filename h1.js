        ...
        fs.readdir(base, (err, files) => {
            ...
            files.forEach(item => {
                ...
                fs.stat(path.join(base, item), (err, stats) => {
                    ...
                    // Далее проверяем если это папака то рекурсивно читаем ее
                    ...
                    // если не папка, значит файл
                        ...
                        // собираем адрес папки куда положим файл
                        ...
                        if (fs.existsSync(path.join(newBase, newFileName))) {
                            newFileName = Math.random() + newFileName;
                        ...
                        fs.copyFile(path.join(base, item), path.join(newBase, newFileName), (err) => {
                            if (err) {
